...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("When working with form fields, you often want to perform some behavior after a value has been selected or deselected. Whenever a user selects a field in Chosen, it triggers a 'change' event on the original form field. That lets you do something like this:"
						.replaceAll("\\w+", "1234"));
